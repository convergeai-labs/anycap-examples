# convergeai-labs org avatar — rainbow ring

**Final asset**: [`avatar-final.png`](avatar-final.png) (1024×1024, no text, gate CLEAN)
...
3. Five i2i colorways on the strongest composition (cyan mono, black-white mono, white+violet core, amber, light-mode).
4. Then the direction flipped: take the official ring itself as the i2i base and explore (dark translation, spectrum flow, white ring + violet spark, amber, light-mode).
5. Finally the rainbow assignment — first attempt was rejected by the gate for a faint icon-template border (UI trace); the regeneration without the stroke passed CLEAN.
6. Full decision board with 64/44/32px simulations; the rainbow ring won.

See [`provenance.md`](provenance.md) for the complete record, and the [anycap-brand-mark-lab](https://github.com/convergeai-labs/anycap-skills/blob/main/skills/anycap-brand-mark-lab/SKILL.md) skill for the distilled method.
